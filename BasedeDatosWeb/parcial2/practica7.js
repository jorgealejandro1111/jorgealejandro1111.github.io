    ...
    if(cuadro.value != "x" && cuadro.value != "o"){
       ...
       var cuadro9= document.getElementById("cuadro9").value;
        ...
        switch(posicion){
            ...
            case 5:
                if(cuadro5 == cuadro4 && cuadro5 == cuadro6){
...
function pintar(p1, p2, p3){
    document.getElementById("cuadro"+p1).style.backgroundColor = "#bdf76c";
    document.getElementById("cuadro"+p2).style.backgroundColor = "#bdf76c";
    document.getElementById("cuadro"+p3).style.backgroundColor = "#bdf76c";
}